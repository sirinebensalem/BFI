...
import { BrowserRouter, Link } from 'react-router-dom'; // Import the Link component from React Router
    ...
    <>
      {
        showSidebar && (
          <div className='min-w-[15%] h-full flex flex-col justify-between bg-[#6e6e6e27] rounded-3xl pt-[10px] pr-6 pb-8 '>
            ...
            <button
    className="ml-[50px] flex items-center font-bold text-gray-800 dark:text-white group-hover:text-purple hover:text-purple bg-gray-200 bg-opacity-50 hover:bg-opacity-70 rounded-full px-[60px] py-2 transition-colors duration-300"
    onClick={() => router.push('/')}>
